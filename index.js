...
console.log("1073.64 =>", monthlyRate)
...
function mortgageCalculator(p, i, y, c) {
    let principal = p;
    let interest = i;
    let years = y;
    let name = 'Candace';
...
*/
function variableInterestRate(n, p, tempI, y) {
    for(let i = 0; i<10;i++) {
        let principal = p;
        let interest = tempI;
        let years = y;
...
variableInterestRate("Candace", 200000, 0.04, 30);
